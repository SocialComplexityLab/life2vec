...
@dataclass
class LabourTokensNoJob(TokenSource):
    """Tokens from the labour data."""

    name: str = "labour_nojob"
    fields: List[FIELD_TYPE] = field(
        default_factory=lambda: [
            #"WORK_MUNICIPALITY",
            Binned("WORK_INCOME", prefix="INCOME", n_bins=100),
...
@dataclass
class LabourTokensNoJobNoPos(TokenSource):
    """Tokens from the labour data."""

    name: str = "labour_nojob_nopos"
    fields: List[FIELD_TYPE] = field(
        default_factory=lambda: [
            #"WORK_MUNICIPALITY",
            Binned("WORK_INCOME", prefix="INCOME", n_bins=100),
...
@dataclass
class LabourTokensNoJobNoSoc(TokenSource):
    """Tokens from the labour data."""

    name: str = "labour_nojob_nosoc"
    fields: List[FIELD_TYPE] = field(
        default_factory=lambda: [
            #"WORK_MUNICIPALITY",
            Binned("WORK_INCOME", prefix="INCOME", n_bins=100),
